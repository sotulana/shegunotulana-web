        ...
        <div className="space-y-16">
          {featuredWork.map((item, idx) => {
            ...
            return (
              <div
                key={item.name}
                className={`card p-10 md:p-14 group relative overflow-hidden max-w-3xl ${alignment} ${rotation} transition-transform duration-500`}
              >
                {/* Animated gradient background */}
                <div className={`absolute ${isEven ? 'top-0 right-0' : 'bottom-0 left-0'} w-80 h-80 bg-gradient-to-br from-primary/15 via-secondary/10 to-transparent rounded-full blur-3xl opacity-50 group-hover:opacity-100 transition-opacity duration-700`}></div>
                ...
                <div className="relative z-10">
                  {item.url ? (
                    ...
                    >
                      ...
                      <div className="text-lg text-muted-foreground group-hover:text-primary transition-colors">
